...
- **Choice of mapper.** MapToRef can map with bowtie2 (default) or bwa-mem, picked in the Assemble options or with `maptoref_mapper` in `new_project()`. The mapper options box applies to whichever is chosen.
