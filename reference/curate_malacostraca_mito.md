...
Thin wrapper around the shared curation core with the malacostracan
genetic code. See \`curate_mito_core()\` for the full argument list and
behavior.

## Usage

``` r
curate_malacostraca_mito(
  annotations_fn = NULL,
  assembly_fn = NULL,
  coverage_fn = NULL,
  genetic_code = 5,
