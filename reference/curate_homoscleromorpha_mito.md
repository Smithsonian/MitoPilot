...
Thin wrapper around the shared curation core with the homoscleromorph
sponge genetic code. See \`curate_mito_core()\` for the full argument
list and behavior.

## Usage

``` r
curate_homoscleromorpha_mito(
  annotations_fn = NULL,
  assembly_fn = NULL,
  coverage_fn = NULL,
  genetic_code = 4,
