...
Before running MitoPilot with your own samples, we recommend trying out the included test project consisting of Illumina data for 13 fish species. The following tutorial provides a step-by-step walkthrough.
