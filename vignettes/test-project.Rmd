...
If you're working on a computing cluster, Nextflow distributes the analyses across multiple batch jobs. You can use your cluster's job scheduler to check on the status of MitoPilot jobs. Some samples may finish faster than others.
