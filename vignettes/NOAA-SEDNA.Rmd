...
For first time setup, you will need to create a Mamba environment for two MitoPilot dependencies, Nextflow and Singularity. We will also include a version of R, as there are some issues running the pipeline with the cluster's R module.

Login to the NOAA NMFS VPN, login to SEDNA, then run the following. This will take a while.
