...
Download the [GenBankDownloadUtil.sh](https://github.com/JonahVentures/MitoPilot/blob/main/ref_dbs/getOrganelle/GenBankDownload//GenBankDownloadUtil.sh) script to the directory where you want to create the reference databases. You will also need to download [parseGB.py](https://github.com/JonahVentures/MitoPilot/blob/main/ref_dbs/getOrganelle/GenBankDownload//parseGB.py) to the same directory.
