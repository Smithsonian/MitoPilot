...
It may also be helpfpul to create a custom database for curation of the protein-coding gene predictions if your taxa are poorly represented in NCBI RefSeq.
...
By default, MitoPilot uses gene sequences from NCBI RefSeq to finetune start and stop codon positions for your annotations. The curation database is specified by the `ref_dir` and `ref_db` sections of the Cutation Opt. panel in the Shiny app. 
