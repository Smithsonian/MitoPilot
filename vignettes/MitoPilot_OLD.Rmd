...
If you are a Smithsonian NMNH user, please see the [2025 workshop website](https://smithsonianworkshops.github.io/MitoPilot_workshop_2025/) for the most up-to-date instructions. The workshop documentation may also be helpful for other users.
...
<div class="alert alert-warning">
  <strong>Warning:</strong> Currently, the `Start Nextflow` button is not compatible with the NOAA SEDNA computing cluster. Please use the command line or batch job method, making sure to run `mamba activate MitoPilot_deps` prior to calling Nextflow.
</div>
