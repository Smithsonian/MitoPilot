...
#'
#' Thin wrapper around the shared curation core with the thaliacean genetic code.
...
#' @param genetic_code Genetic code to use (default = 13)
...
#' @export
#'
curate_thaliacea_mito <- function(
    annotations_fn = NULL,
    assembly_fn = NULL,
    coverage_fn = NULL,
    genetic_code = 13,
