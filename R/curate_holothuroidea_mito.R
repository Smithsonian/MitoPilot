...
#'
#' Thin wrapper around the shared curation core with the sea cucumber genetic code.
...
#' @param genetic_code Genetic code to use (default = 9)
...
#' @export
#'
curate_holothuroidea_mito <- function(
    annotations_fn = NULL,
    assembly_fn = NULL,
    coverage_fn = NULL,
    genetic_code = 9,
