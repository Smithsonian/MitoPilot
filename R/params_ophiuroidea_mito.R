#' Default curation and validation parameters for Ophiuroidea mitochondria
#'
...
#' @export
#'
params_ophiuroidea_mito <- function(alt = list()) {
  params <- list(
    hit_threshold = 60,
    max_overlap = 0.25,
    default_rules = list(
