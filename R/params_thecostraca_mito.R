#' Default curation and validation parameters for Thecostraca mitochondria
#'
...
#' @export
#'
params_thecostraca_mito <- function(alt = list()) {
  params <- list(
    hit_threshold = 60,
    max_overlap = 0.25,
    default_rules = list(
    ...
    rules = list(
      ...
      cox1 = list(
        type = "PCG",
        start_codons = c("ATG", "GTG", "ATA", "ATT", "ATC", "TTG", "ACG", "TCG"),
