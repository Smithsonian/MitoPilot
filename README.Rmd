...
1. Mitogenome assembly
   ...
   - [NCBI BLAST](https://blast.ncbi.nlm.nih.gov/Blast.cgi) remotely fetch closest match from GenBank for automatic and manual curation 
...
+ NCBI Api Key
  - We highly recommended [generating a NCBI API key](https://www.ncbi.nlm.nih.gov/datasets/docs/v2/api/api-keys/) and providing it here during project initialization. This will increase the efficiency of the remote BLAST search and corresponding GenBank downloads during the Assemble module.
