...
- **Devin Leopold**. Author.

- **Dan MacGuigan**. Author, maintainer.
...
Leopold D, MacGuigan D (2025). *MitoPilot: Mitogenome assembly,
annotation, and curation*. R package version 1.3.6,
